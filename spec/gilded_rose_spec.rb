...
RSpec.describe GildedRose do
  context "Normal Item" do
    it "before sell date" do
      normal_item = NormalItem.new(days_remaining: 5, quality: 10)
      gilded_rose = GildedRose.new(name: "Normal Item", days_remaining: 5, quality: 10, item: normal_item)
    ...
    it "on sell date" do
      normal_item = NormalItem.new(days_remaining: 0, quality: 10)
      gilded_rose = GildedRose.new(name: "Normal Item", days_remaining: 0, quality: 10, item: normal_item)
